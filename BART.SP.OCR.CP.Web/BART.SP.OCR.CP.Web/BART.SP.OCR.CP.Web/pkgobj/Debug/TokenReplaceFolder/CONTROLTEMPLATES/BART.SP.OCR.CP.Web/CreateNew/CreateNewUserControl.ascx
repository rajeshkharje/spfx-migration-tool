        ...
        <asp:Panel ID="pnlStep1" CssClass="col-md-12" runat="server">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div id="div_SponsorProjectManager" data-toggle="tooltip" label="Sponsor Project Manager" title="Your immediate manager" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_GroupManager" data-toggle="tooltip" title="Group Manager or equivalent" label="Project Sponsor Group Manager" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_DepartmentChief" data-toggle="tooltip" label="Sponsoring Department Chief" title="Department Chief or equivalent" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txt_KickoffMeetingDate" data-toggle="tooltip" label="Kickoff Meeting Date" ToolTip="The project team must schedule a kickoff meeting with OCR and Procurement" placeholder="MM/DD/YYYY" CssClass="form-control datepickertxt" runat="server"></asp:TextBox>
                    </div>
