        ...
        <asp:Panel ID="pnlStep1" CssClass="col-md-12" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <label>
                                Project Sponsor’s Manager
                            </label><span class="markRequired">*</span>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_SponsorProjectManager" title="Your immediate manager" data-toggle="tooltip" label="Sponsor Project Manager" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <label>
                                Project Sponsor’s Group Manager
                            </label><span class="markRequired">*</span>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_GroupManager" title="Group Manager or equivalent" data-toggle="tooltip" label="Project Sponsor Group Manager" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <label>
                                Sponsoring Department Chief
                            </label><span class="markRequired">*</span>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_DepartmentChief" title="Department Chief or equivalent" data-toggle="tooltip" label="Sponsoring Department Chief" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txt_KickoffMeetingDate" data-toggle="tooltip" ToolTip="The project team must schedule a kickoff meeting with OCR and Procurement" label="Kickoff Meeting Date" placeholder="MM/DD/YYYY" CssClass="form-control datepickertxt" runat="server"></asp:TextBox>
                    </div>
                 ...
                 <div class="col-md-12">
                    ...
                    <asp:Repeater ID="rpt_Contracts" runat="server" OnItemDataBound="rpt_Contracts_ItemDataBound">
                     ...
                     <div class="col-md-12 contractform" style="margin-bottom:10px;">
                        ...
                        <div class="row" style="margin-top:10px; margin-bottom:5px;">
                         ...
                         <div class="col-md-4">
                           ...
                           <asp:TextBox CssClass="form-control floatInput" label="Dollar Amount" data-toggle="tooltip" Text='<%# Eval("DollarAmount")%>' ID="txt_DollarAmount" placeholder="$" runat="server"></asp:TextBox>
                        </div>
                         <div class="col-md-4">
                            <label class="lblforField">
                                Contract Status
                     ...
                     <asp:Panel ID="pnlAddNewLink" runat="server" CssClass="col-md-12 row">
                         <hr />
                        <asp:LinkButton ID="lbt_AddNew" OnClick="lbt_AddNew_Click" Font-Bold="true" ForeColor="#006600" runat="server"><i class="fa fa-plus" aria-hidden="true"></i> Add New Contract</asp:LinkButton>
                         <br /><br />
