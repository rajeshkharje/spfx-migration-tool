...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditUserControl.ascx.cs" Inherits="BART.SP.OCR.CP.Web.Edit.EditUserControl" %>
...
<script>
    ...
    function loaddocs()
    {
        ...
        if (cStatus == '<%=BART.SP.OCR.CP.Common.ProjectSettings.ProjectStatusCompleted%>') {$('.sswpuploadedDocuments li a.removeUploadedFile').hide();}
        else {
            LoadRemoveUploadedFile('<%= this.hdfDeletedDocMarkIDs.ClientID %>','<%= this.hdfDeletedContractDocMarkIDs.ClientID %>');
    ...
    function updateApproversValue()
    {
        ...
        //----
        var allLogin = $('#' + '<%= this.hdf_SponsorProjectManagerLogin.ClientID %>').val() + '_' + $('#' + '<%= this.hdf_GroupManagerLogin.ClientID %>').val() + '_' +
            $('#' + '<%= this.hdf_DepartmentChiefLogin.ClientID %>').val() + '_' + $('#' + '<%= this.hdf_DepartmentAGMLogin.ClientID %>').val();
        $('.txtPostPM_GPM_Cf_AGM').val(allLogin);
...
<asp:Panel runat="server" ID="pnlSuccessMsg" Visible="false" CssClass="alert alert-success alert-dismissable pnlErrorMsgCss"> 
        <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
        <asp:Label ID="lblComplete" runat="server">Your changes was saved successfully.</asp:Label>
</asp:Panel>
...
<ul class="nav nav-tabs" id="myTabs" role="tablist" style="margin-left:-12px;">
    ...
    <li style="float:right">
      <div style="margin-top:-3px;">
        ...
        <a data-toggle="tooltip" title="Save changes and route for department's manager approval" runat="server" id="btnSubmitForApprovalTop" onclick="return SavenRoute();" class="btn btn-primary btnAction btnMoveStep submit4Approval">Submit for Approval</a>
        <a data-toggle="tooltip" title="Save changes and re-route for department's manager approval" runat="server" id="btnReRouteForApprovalTop" onclick="return SavenRe_Route();" class="btn btn-primary btnAction btnMoveStep submit4Approval">Re-Route</a>
        ...
        <asp:Panel ID="pnlStep1" CssClass="col-md-12" runat="server">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:Panel ID="pnlInstruction1" CssClass="fright" runat="server">
                                <span  class="lblTop lblSubRight" data-toggle="tooltip" title="If your project doesn't belong to any program then please choose N/A. Otherwise please create a new project with appropriate program if your program is not in this list.">Can't find your program?</span>
                            </asp:Panel>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <div id="div_SponsorProjectManager" title="Project Manager" data-toggle="tooltip" label="Project Manager" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_GroupManager" title="Group Manager or equivalent" data-toggle="tooltip" label="Project Group Manager" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                                <div id="div_DepartmentChief" title="Department Chief /Director or equivalent" data-toggle="tooltip" label="Department Chief /Director" class="form-control divUserInputField userfieldrequired"></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txt_KickoffMeetingDate" data-toggle="tooltip" ToolTip="The project team must schedule a kickoff meeting with OCR and Procurement" label="Kickoff Meeting Date" placeholder="MM/DD/YYYY" CssClass="form-control datepickertxt cssRequired" runat="server"></asp:TextBox>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <asp:Panel ID="pnl_OCRGeneralInfo" CssClass="row" runat="server">
                                ...
                                <div class="col-md-6">
                                    <p>&nbsp;</p>
                                    <%-- <asp:CheckBox ID="cb_OCROver10M_Yes" ForeColor="#0066cc" Text="Construction contract over $5M ?" data-toggle="tooltip" ToolTip="Check this box if this contracting plan includes a construction contract that is $5M or more. This will notify the Labor Compliance Unit" Enabled="false" runat="server" CssClass="cb_OCROver10M_Yes ocronly" />--%>
                    ...
                    <asp:Repeater ID="rpt_Contracts" runat="server" OnItemDataBound="rpt_Contracts_ItemDataBound">
                     ...
                     <div class="col-md-12 contractform" style="margin-bottom:10px;">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox runat="server" Text='<%# Eval("OCRAnalysis")%>' label="OCR analysis for this contract" TextMode="MultiLine"  CssClass="form-control txtMultipleLines txt_OCRAnalysis OCRAnalysis ocronly" Enabled='<%# this.IfOCRAnalyst%>' ID="txt_OCRAnalysis" ></asp:TextBox>
                          </div>
                        </div>
                     ...
                     <asp:Panel ID="pnlAddNewLink" runat="server" CssClass="col-md-12 row">
                         <hr />
                        <asp:LinkButton ID="lbt_AddNew" OnClick="lbt_AddNew_Click" CssClass="lnkAddNewContract" Font-Bold="true" ForeColor="#006600" runat="server"><i class="fa fa-plus" aria-hidden="true"></i> Add New Contract</asp:LinkButton>
                         <br /><br />
                    ...
                    <div class="modal-dialog" style="margin-top:12%;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" runat="server" id="btnRemoveContract" onclick="showLoadingDiv();" onserverclick="btnRemoveContract_ServerClick" data-dismiss="modal" class="btn btn-primary commitAction btnRemoveContract" title="Remove Contract" >
                                    Yes
                                </button>
...
<div class="tab-pane fade" id="step5">
   <div class="row divcontainerHistory">
       <h4 style="margin-top: 0px; margin-bottom: 2px; text-transform: uppercase; border-bottom: 1px dashed lightgray; font-size:16px; color: #c35939;">Previous Version(s)</h4>
       <asp:Label ID="lblPreviousVer" runat="server" Text="(There is no previous version)"></asp:Label>


       <h4 style="text-transform: uppercase; margin-top: 0px; text-transform: uppercase; border-bottom: 1px dashed lightgray; font-size:16px; color: #c35939; margin-bottom: 2px; margin-top: 15px;">Activity Logs</h4>
...
<asp:HiddenField ID="hdfDeletedContractDocMarkIDs" runat="server" />
...
<asp:TextBox ID="txtAccessLevel2CP" CssClass="ctrlHidden txtAccessLevel2CP" Text="-1" runat="server"></asp:TextBox>
<asp:TextBox ID="txt_SponsorDepartment" CssClass="ctrlHidden txt_SponsorDepartment" Text="" runat="server"></asp:TextBox>


<asp:TextBox runat="server" ID="hdfCurrentTab" CssClass="hdfCurrentTab ctrlHidden"></asp:TextBox>
<asp:TextBox runat="server" ID="txtExportURL" CssClass="form-control ctrlHidden txtExportURL"></asp:TextBox>
...
<asp:TextBox ID="txtOriginalPM_GPM_Cf_AGM" CssClass="ctrlHidden txtOriginalPM_GPM_Cf_AGM" runat="server"></asp:TextBox>
<asp:TextBox ID="txtPostPM_GPM_Cf_AGM" CssClass="ctrlHidden txtPostPM_GPM_Cf_AGM" runat="server"></asp:TextBox>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <%--   <button type="button" runat="server" id="btnSavePreview" onclick="showLoadingDiv();" data-dismiss="modal" class="btn btn-primary commitAction btnSavePreviewSubmit" onserverclick="btnCommitSave_ServerClick" title="Save changes">
                    ...
                    <button type="button" class="btn btn-primary btnReroutewExport hidelow" onclick="RunExportFiles();" data-dismiss="modal" title="Save and Re-Route">Yes</button>
...
<iframe style="display:none" id="ifrExport" src=''></iframe>
